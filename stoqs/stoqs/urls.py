...
urlpatterns = [
    ...
    re_path(pre + r'api/campaignresource.?' + formatPat,
            showCampaignResource,          {}, name='show-campaignresource'),
    ...
    re_path(pre + r'api/measuredparameterresource.?' + formatPat,
            showMeasuredParameterResource,  {}, name='show-measuredparameterresource'),
    re_path(pre + r'api/measurement.?' + formatPat, showMeasurement,       {}, name='show-measurement'),
    re_path(pre + r'api/parametergroupparameter.?' + formatPat,
            showParameterGroupParameter,    {}, name='show-parametergroupparameter'),
